...
export default {
  ...
  async deletarProduto(id) {
    try {
      // Note que seu backend usa PUT para deletar, diferente do usual DELETE
  ...
  async listarProdutosPorFiltro(nome, codigoProduto) {
    try {
      const params = {};
      if (nome) params.nome = nome;
      if (codigoProduto) params.codigoProduto = codigoProduto;
